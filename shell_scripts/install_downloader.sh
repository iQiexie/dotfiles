...
sudo pacman -S --noconfirm qtile zsh zsh-syntax-highlighting ttf-ms-fonts xorg-xrandr alacritty gst-plugins-good gst-libav pulseaudio alsa-utils bc xdg-utils nss xwallpaper
