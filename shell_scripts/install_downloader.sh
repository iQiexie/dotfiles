...
sudo pacman -S --noconfirm qtile zsh zsh-syntax-highlighting ttf-font xorg-xrandr xwallpaper alacritty gst-plugins-good gst-libav pulseaudio alsa-utils bc xdg-utils nss  zip unzip
