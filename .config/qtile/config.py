...
keys = [
    ...
    Key(
        [mod, "shift"],
        "1",
        lazy.function(move_current_window_to_screen, 0),
        desc="Move window to the 1st monitor",
    ),
    Key(
        [mod, "shift"],
        "2",
        lazy.function(move_current_window_to_screen, 1),
        desc="Move window to the 2nd monitor",
    ),
    Key(
        [mod, "shift"],
        "3",
        lazy.function(move_current_window_to_screen, 2),
        desc="Move window to the 3rd monitor",
    ),
    ...
    Key(
        ...
        "space",
        lazy.next_layout(),
        desc="Toggle between layouts (maximize window)",
    ),
]
...
def init_widgets(screen_id):
    return [
        ...
        # 	max_chars=15
        # ),
        widget.TaskList(max_title_width=150),
        widget.Systray(),
        widget.Battery(),
        widget.Volume(
            padding=10,
...
def init_screen(screen_id):
    return Screen(bottom=bar.Bar(widgets=init_widgets(screen_id), size=27))
